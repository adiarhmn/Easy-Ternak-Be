...
class KelolaPenggunaAdminController extends Controller
{
    ...
    public function investor()
    {
        ...
        $data = [
            ...
            'topbar' => 'Investor',
            'btnAdd' => 'Tambah',
            'urlAdd' => 'admin/pengguna/investor/tambah',
        ];
    ...
    public function tambahInvestor()
    {
        ...
        $data = [
            'title' => 'EasyTernak | Tambah Investor',
            'page' => 'Pengguna',
            'topbar' => 'Investor',
        ];

        return view('pages.admin.kelola-pengguna.tambah-investor', $data);
    }
    
    public function simpanInvestor(Request $request)
    {
        $request->validate([
            'name' => 'required|string|max:255',
            'username' => 'required|string|max:255|unique:user,username',
        ...
        // Simpan data investor di tabel investor
        $data['id_user'] = $userId;
        $data['name'] = $request->input('name');
        $data['telephone'] = $request->input('telephone');
        $data['address'] = $request->input('address');
        ...
        DB::table('investor')->insert($data);

        // Redirect ke halaman sebelumnya dengan pesan sukses
        return redirect()->to('admin/pengguna/investor')->with('success', 'Investor berhasil ditambahkan!');
    }
    ...
    public function updateInvestor(Request $request, $id)
    {
        ...
        if (!$investor) {
            return redirect()->back()->withErrors(['msg' => 'investor tidak ditemukan']);
        }
        ...
        return redirect()->to('admin/pengguna/investor/profil/' . $id)->with('success', 'Data berhasil diperbarui');
    }
