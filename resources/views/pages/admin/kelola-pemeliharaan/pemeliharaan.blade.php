                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-end mt-2">
                                        <div style="margin-right: 5px" class="ml-auto">
                                            <a href="{{url('admin/pemeliharaan/progres/'.$animal->id)}}" class="btn btn-secondary btn-sm">Lihat Progress</a>
                                        </div>
                                        <div class="ml-auto">
                                            <a href="{{url('admin/pemeliharaan/jual/'.$animal->id)}}" class="btn btn-danger btn-sm">Jual</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
